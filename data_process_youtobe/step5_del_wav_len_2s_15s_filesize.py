...
def step5_filter_wav_len_2s_15s_filesize(in_dir):
    global g_suffix_del
    #
    file_list = os.listdir(in_dir)
    # file_list.sort()
    ...
    for i in tqdm(range(len(file_list))):
        ...
        cur_filesize = os.path.getsize(cur_file_path)
        #
        #
        # print("file=",cur_file_path,",size=",cur_filesize,",wav_len=",wav_len)
        
        # print(audio_data.shape)
        
        
        #
        if(cur_filesize <= 120000 or cur_filesize >= 1419000):
            os.remove(cur_file_path)
...
if __name__ == "__main__":
    ...
    # in_dir = "tmp_0001"
    #
    step5_filter_wav_len_2s_15s_filesize(in_dir)
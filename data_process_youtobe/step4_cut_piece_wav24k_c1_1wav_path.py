...
def get_out_wav_path(out_dir):
    global g_out_index
    #
    out_wav_name = "{0:06d}".format(g_out_index) + ".wav"
    g_out_index += 1
    #
...
def step4_cut_piece_wav24k_c1_1wav_path(in_wav_path, out_wav_dir):
...
if __name__ == "__main__":
    ...
    #
    in_wav_path = "D:\\t_0004\\in_wav24k\\000000.wav"
    out_wav_dir = "D:\\t_0004\\out_wav24k"
    #
    step4_cut_piece_wav24k_c1_1wav_path(in_wav_path, out_wav_dir)



    # step4_cut_piece_wav24k_c1_wav_txt()

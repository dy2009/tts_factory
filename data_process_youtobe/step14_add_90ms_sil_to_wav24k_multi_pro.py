...
def step7_add_90ms_sil_to_wav24k(in_dir,out_dir):
    global g_suffix_del
    #
    ...
    for i in tqdm(range(len(file_list))):
        ...
        # step7_add_90ms_sil_to_wav24k_1wav(cur_file_path,dst_file_path)
...
if __name__ == "__main__":
    ...
    out_dir = "wav24k_piece_0002"
    
    
    step7_add_90ms_sil_to_wav24k(in_dir,out_dir)

...
def get_16k_mel_hifigan_tensor(in_audio, In_Sample_Rate=16000, n_fft=1024, num_mels=100, win_size = 640, hop_size = 160, fmin = 0, fmax = 8000):
...
def get_16k_mel_hifigan_wav(wav_path, In_Sample_Rate=16000, n_fft=1024, num_mels=100, win_size = 640, hop_size = 160, fmin = 0, fmax = 8000):

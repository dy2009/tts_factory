...
def cut_head_tail_and_add_sil(cur_file_path,out_dir,cur_file):
    ...
    start_sil_ms = random.randint(20, 90)
    end_sil_ms = random.randint(20, 90)

    # 150ms
    head_sil_150ms = start_sil_ms * int(g_sample_rate / 1000)
    tail_sil_150ms = end_sil_ms * int(g_sample_rate / 1000)

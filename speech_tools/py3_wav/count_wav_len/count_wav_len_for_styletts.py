...
def print_len_info(len_all_s):
    ...
    #
    print("wav_len = ",wav_len_hour ," hour, ", wav_len_minute ," minute, ", minute_rest ," second.")
...
def count_wav_len_for_styletts(in_txt):
    #
    cur_f = open(in_txt,"r",encoding="utf8")
    #
    txt_list = []
    ...
    for curLine in cur_f.readlines():
        ...
        #
        cur_wav_buf,cur_sr = sf.read(cur_wav)
        #
...
if __name__ == "__main__":
    in_txt = sys.argv[1]
    #
    count_wav_len_for_styletts(in_txt)
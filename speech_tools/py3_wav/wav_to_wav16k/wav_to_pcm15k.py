...
def wav_to_wav16k(in_dir,out_dir):
    ...
    for i in tqdm(range(len(file_list))):
        ...
        new_file = new_file.replace("_00","_01")


        dst_file_path = os.path.join(out_dir,new_file)

        #
        # sox input.wav -t raw -r 16000 -e signed-integer -b 16 output.pcm


        sox_com = "sox " + cur_file_path + " -r 15000 -e signed-integer  -b 16 " + dst_file_path
        #
        os.system(sox_com)
    #
    return 

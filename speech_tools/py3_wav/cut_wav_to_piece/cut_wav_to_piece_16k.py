...
def cut_wav_sil(cur_file_path,out_dir,bflag_add_sil,out_name):
    global g_sample_rate
    global g_bit_depth
    #
    global g_index
    ...
    while(True):
        ...
        if(not bflag_have_wav):
            ...
            if(cur_buf_e < g_sil_energy_threshold):
                ...
                #
                dst_name = out_name + "{0:06d}".format(g_index) + ".wav"
...
def wav_to_wav16k(in_dir,out_dir,bflag_add_sil,out_name):
    global g_suffix_del
    global g_index
    #
    ...
    for i in tqdm(range(len(file_list))):
        ...
        #
        cut_wav_sil(cur_file_path,out_dir,bflag_add_sil,out_name)
        #
...
if __name__ == "__main__":
    ...
    #
    wav_to_wav16k(in_dir,out_dir,bflag_add_sil,out_name)

...
def cut_head_tail_and_add_sil(cur_file_path,out_dir,cur_file):
    ...
    #
    in_wav_short_01 = in_wav * math.pow(2,23)
    ...
    head_sil = np.random.randint(-20,20,sil_150ms) / math.pow(2,23)
    tail_sil = np.random.randint(-20,20,sil_150ms) / math.pow(2,23)
    ...
    #
    sf.write(dst_wav_path,out_wav,48000)

    return 


def wav_to_wav48k_24b(in_dir,out_dir):
    global g_suffix_del
...
if __name__ == "__main__":
    ...
    out_dir = sys.argv[2]
    #
    wav_to_wav48k_24b(in_dir,out_dir)
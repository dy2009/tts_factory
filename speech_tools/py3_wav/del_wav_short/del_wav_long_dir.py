...
def count_wav_len_dir(in_dir,short_wav_len,long_wav_len):
    #
    ...
    for i in range(len(file_list)):
        ...
        try:
            ...
            count_num += 1
            #
            if(cur_wav_len_s <= short_wav_len or cur_wav_len_s >= long_wav_len):
...
if __name__ == "__main__":
    ...
    long_wav_len = 16.0
    #
    count_wav_len_dir(in_dir,short_wav_len,long_wav_len)
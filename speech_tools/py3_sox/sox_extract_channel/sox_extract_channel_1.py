...
def sox_extract_channel(in_dir,out_dir,channel_int=1):
    global g_channel_str
    global g_suffix_del
    #
    ...
    for i in range(len(file_list)):
        ...
        #
        # 1= left, 2=right
        sox_com = "sox " + cur_file_path + " " + dst_file_path + " remix " + str(channel_int)
        #
        os.system(sox_com)
    #
    return 
...
if __name__ == "__main__":
    ...
    channel_int = 1
    #
    sox_extract_channel(in_dir,out_dir,channel_int)